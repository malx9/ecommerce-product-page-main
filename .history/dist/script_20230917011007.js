...
lbNext.addEventListener("click", () => {
  console.log("Before setting src:", lbMainPic.src);
  lbMainPic.src = `images/image-product-${currentpicID}.jpg?random=${Math.random()}`;
  console.log("After setting src:", lbMainPic.src);
  currentpicID++;
